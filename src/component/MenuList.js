        ...
        <Dropdown style={{ height: menuHeight }} ref={dropdownRef}>
            <CSSTransition in={activeMenu === 'main'} timeout={500} unmountOnExit onEnter={calcHeight} classNames="depth1">
                <ul className="menu">
                    ...
                    <MenuItem name="menu2" icon={<CupIcon />}>
                        Beverage
                    </MenuItem>
                    <MenuItem name="menu3" icon={<ContactIcon />}>
                        Contact
                    </MenuItem>
                </ul>
            </CSSTransition>
            <CSSTransition in={activeMenu === 'menu1'} timeout={500} unmountOnExit onEnter={calcHeight} classNames="depth2">
                <ul className="menu">
            ...
            <CSSTransition in={activeMenu === 'menu2'} timeout={500} unmountOnExit onEnter={calcHeight} classNames="depth2">
                <ul className="menu">
                    <MenuItem name="main" icon={<BackIcon />}>
                        뒤로가기
                    </MenuItem>
            ...
            <CSSTransition in={activeMenu === 'menu3'} timeout={500} unmountOnExit onEnter={calcHeight} classNames="depth2">
                <ul className="menu">
                    <MenuItem name="main" icon={<BackIcon />}>
                        뒤로가기
                    </MenuItem>
